...
export default function ArchivedStudyRow({ study }: Props) {
  return (
    <div className="flex flex-col gap-4 rounded-2xl border border-[var(--border)] bg-[var(--bg-sunken)]/40 px-5 py-5 shadow-sm sm:flex-row sm:items-center sm:justify-between">
      <div className="min-w-0">
        ...
        <p className="tabular mt-2 text-sm text-slate-500">
